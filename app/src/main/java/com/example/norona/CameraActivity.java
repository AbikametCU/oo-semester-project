...
import com.example.norona.env.ImageUtils;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected Model model = Model.QUANTIZED_MOBILENET;
  ...
  protected boolean isHardwareLevelSupported(
  ...
  protected void setFragment() {
    ...
    LOGGER.i("CameraActivity Camera Chosen: %s",cameraId);
    Fragment fragment;
    if (useCamera2API) {
